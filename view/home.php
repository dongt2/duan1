                        ...
                        <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">Gravity (2013)  </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">The Hobbit: The Desolation of Smaug (2013)  </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">The Hunger Games: Catching Fire (2013)   </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">Thor: The Dark World (2013) </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--left">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">World War Z (2013)  </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--left">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">Prisoners (2013) </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--light movie--test--right">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">This Is the End (2013)   </a>
                         ...
                         <!-- Movie variant with time -->
                            <div class="movie movie--test movie--test--dark movie--test--right">
                                ...
                                <div class="movie__info">
                                    <a href='#' class="movie__title">The Internship (2013)  </a>
